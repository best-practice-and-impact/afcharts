...
- We believe it is unproductive for departments to create their own colour palettes, as this would likely result in duplicate work.
- Publications hosted on [GOV.UK](https://www.gov.uk/) have minimal departmental branding, so unique colour palettes are unecessary.
- Maintaining a departmental colour palette is challenging because it requires the afcharts team to be in regular contact with the appropriate business area of said department, and it relies on the assumption that proper handover of contacts will always happen when people move roles in and out of that business area.\
- There are too many departments to realistically be able to maintain colour palettes for.
