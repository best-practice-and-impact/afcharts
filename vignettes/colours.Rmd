...
- For 2 categorical values, dark-blue is selected as the primary colour and orange as the secondary colour.
- For 3 categorical values, dark-blue is selected as the primary colour, followed by turqouise as the secondary colour and dark-pink as the tertiary colour.
- For 4 categorical values, the colours are given in the order dark-blue, turqouise, dark-pink, and orange.
- For 5 categorical values, the colours are given in the order dark-blue, turqouise, dark-pink, orange, and dark-grey.
- Finally, for 6 categorical values, the colours are given in the order dark-blue, turqouise, dark-pink, orange, dark-grey, and light-purple.

It is recommended that charts contain no more than 4 different categorical values, and no more than 6 are supported by afcharts.
