...
The y-axis title should be horizontal, not vertical. This can sometimes look odd, especially for longer labels. You can shorten the y-axis label or use the plot subtitle as a description of the y-axis and set the y-axis label to `NULL`.
