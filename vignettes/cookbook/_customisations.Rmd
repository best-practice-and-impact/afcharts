...
This stacked bar uses the afcharts theme. The y axis is labelled from every 25 from 0 to 100 percent, with light grey grid lines and tick marks going horizontally from the y axis. 
...
In this bar chart image, the y axis label and graph title text have been wrapped onto two lines so that all the text is visible.
