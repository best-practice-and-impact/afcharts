...
#| fig.alt = "A bar chart with title, y-axis title and caption. The x-axis title has been removed."
...
#| fig.alt = "A bar chart with title, subtitle and caption. The y axis title has been set using the subtitle."
