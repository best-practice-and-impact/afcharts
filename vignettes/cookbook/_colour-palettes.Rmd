...
These palettes have been developed to meet the [Web Content Accessibility Guidelines 2.2 for graphical objects](https://www.w3.org/WAI/WCAG22/Understanding/non-text-contrast.html).


The [categorical palette](https://best-practice-and-impact.github.io/afcharts/articles/colours.html#main-palette) is the default for discrete colour or fill functions, and the [sequential palette](https://best-practice-and-impact.github.io/afcharts/articles/colours.html#sequential-palette) for continuous colour or fill functions.
...
This line chart uses the afcharts theme and the Analysis Function categorical2 palette, with one line in dark blue and one in orange.
