...
```{r chart-types, child = "cookbook/_chart-types.qmd"} 
```

```{r annotations, child = "cookbook/_annotations.qmd"} 
```

```{r customisations, child = "cookbook/_customisations.qmd"} 
```

```{r colour-palettes, child = "cookbook/_colour-palettes.qmd"} 
```

```{r acknowledgments, child = "cookbook/_acknowledgments.qmd"} 
```
