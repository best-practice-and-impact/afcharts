...
```{r, fig.width=7, fig.hight=5, echo = FALSE}
<<ex1>>
```
...
```{r ex2, fig.width=7, fig.hight=5, eval = FALSE}
...
```{r ex3, fig.width=7, fig.hight=5, eval = FALSE}
afcharts::use_afcharts()
...
The line chart above has a white background, light grey horizontal grid lines, an dark blue  line representing the UK, and a orange line representing China.
