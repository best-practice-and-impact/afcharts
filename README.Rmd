...
<div style="font-size: 16pt;font-weight: 700;">The U.S.A. is the most populous country in the Americas</div>
<div style="font-size: 14pt;">Population of countries in the Americas (millions), 2007</div>
...
<div style= "font-size: 16pt;font-weight: 700;">Living Longer</div>
<div style="font-size: 14pt;">Life Expectancy in the United Kingdom and China 1952 to 2007</div>

```{r, echo = FALSE}
<<ex3>>
```

The line chart above has a white background, light grey horizontal grid lines, an orange line representing the UK, and a dark blue line representing China.
